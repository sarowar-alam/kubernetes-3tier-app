...
#
# Usage:
#   scp k8s-LoadBalancer-annotations/setup-ecr-on-nodes.sh ubuntu@<master-ip>:~/
#   scp k8s-LoadBalancer-annotations/setup-ecr-on-nodes.sh ubuntu@<worker-ip>:~/
#   ssh ubuntu@<master-ip> "sudo bash ~/setup-ecr-on-nodes.sh"
#   ssh ubuntu@<worker-ip> "sudo bash ~/setup-ecr-on-nodes.sh"
#
# Prerequisites:
